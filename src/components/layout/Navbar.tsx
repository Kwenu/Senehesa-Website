...
export function Navbar() {
  ...
  return (
    <header
      ...
      <div className="hidden bg-navy py-2 text-sm text-mist/90 lg:block">
      ...
      <nav
        ...
        className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-5 py-4 sm:px-8 lg:gap-5">
        ...
        <ul className="hidden min-w-0 flex-1 items-center justify-center gap-0.5 lg:flex xl:gap-1">
          ...
          <li key={link.to} className="min-w-0">
              ...
              to={link.to}
              className={({ isActive }) =>
              `block whitespace-nowrap rounded-full px-2.5 py-2 text-[13px] font-semibold transition-colors xl:px-3.5 xl:text-[15px] ${
              isActive ?
